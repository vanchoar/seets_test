...
class Encryptions {
  ...
  private function __construct(string $encryption_method)
  {
    $this->encryption_method = $encryption_method;
    $this->key = "your_amazing_key_here";
  }

  public static function Create128AESEncryption(): Encryptions{
    return new Encryptions("AES-128-CBC");
  }

  public function encrypt($data) {
      $ivlen = openssl_cipher_iv_length($this->encryption_method);
      $iv = openssl_random_pseudo_bytes($ivlen);
      $ciphertext_raw = openssl_encrypt($data, $this->encryption_method, $this->key, $options = OPENSSL_RAW_DATA, $iv);
  ...
  public function decrypt($data) {
      ...
      $original_plaintext = openssl_decrypt($ciphertext_raw, $this->encryption_method, $this->key, $options = OPENSSL_RAW_DATA, $iv);
...
$encryptions = Encryptions::Create128AESEncryption();
